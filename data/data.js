const data = [
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("babyClue"))
      : false,
    place: "send",
    name: "寶物線索",
    img: "/images/babyClue.jpeg",
    description: "似乎是個很重要的東西",
  },
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("stone"))
      : false,
    place: "send",
    name: "遺跡石板",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("placePoint"))
      : false,
    place: "埃及",
    name: "犯案地點",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("prove"))
      : false,
    place: "埃及",
    name: "辦案證明",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("white"))
      : false,
    place: "埃及",
    name: "清白證明",
    img: "/images/white.jpeg",
    description:
      "能夠避免說出「你們是誰？」「你們要幹嘛？」「你們要帶我去哪裡？",
  },
  {
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("dieTime"))
      : false,
    place: "埃及",
    name: "死亡時間",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("babyStone"))
      : false,
    place: "埃及",
    name: "寶石",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("dieProve"))
      : false,
    place: "埃及",
    name: "寶物（死者蘇生的法器）",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("peopleProve"))
      : false,
    place: "埃及",
    name: "身分證明",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("goOut"))
      : false,
    place: "埃及",
    name: "出境人口簿",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("greatGoOut"))
      : false,
    place: "埃及",
    name: "正確的出境人口簿",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("bigBag"))
      : false,
    place: "埃及",
    name: "一大袋金幣",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("diePeople"))
      : false,
    place: "埃及",
    name: "驗屍單",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("formalin"))
      : false,
    place: "埃及",
    name: "福馬林",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("sweating"))
      : false,
    place: "埃及",
    name: "出汗劑",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("sweetSweating"))
      : false,
    place: "埃及",
    name: "香汗",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("mouthWater"))
      : false,
    place: "埃及",
    name: "很臭的口水",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("finger"))
      : false,
    place: "埃及",
    name: "指紋採樣樣本",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("lookmouth"))
      : false,
    place: "埃及",
    name: "目擊者口證",
    img: "/images/lookmouth.jpeg",
    description:
      "你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹你從桃園新竹",
  },
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("pencile"))
      : false,
    place: "埃及",
    name: "偵查筆錄",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("sayWrong"))
      : false,
    place: "埃及",
    name: "說謊證明",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("knife"))
      : false,
    place: "埃及",
    name: "詭異的刀",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("uncall"))
      : false,
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("yanho"))
      : false,
    name: "艷后剪影",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("bodyHair"))
      : false,
    name: "沙漠哺乳動物的體毛",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("please"))
      : false,
    place: "日本",
    name: "木匠的委託單",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("glasses"))
      : false,
    place: "日本",
    name: "玻璃瓶",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("swood"))
      : false,
    place: "日本",
    name: "特殊木材",
    description: "怎麼又是這個圓",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("sfoodtail"))
      : false,
    place: "日本",
    name: "祈福斧頭",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("fixbox"))
      : false,
    place: "日本",
    name: "修復專用工具",
    description: "你砍完樹了嗎...?",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("foodtail"))
      : false,
    place: "日本",
    name: "一般斧頭",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("giantbook"))
      : false,
    place: "日本",
    name: "散落的劇本",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("avoidsun"))
      : false,
    place: "日本",
    name: "遮陽棚材料",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("woodCount"))
      : false,
    place: "日本",
    name: "圓木",
    description: "似乎是這種木頭",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("breaktool"))
      : false,
    place: "日本",
    name: "壞掉的工具",
    description: "阿，壞掉了...",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("boliou"))
      : false,
    place: "日本",
    name: "布料",
    description: "修復旗幟的材料",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("drewhorse"))
      : false,
    place: "日本",
    name: "繪馬",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("bigGood"))
      : false,
    place: "日本",
    name: "大吉籤",
    description: "代表著非常好運",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("gioubotal"))
      : false,
    place: "日本",
    name: "釀酒容器",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("fiveto"))
      : false,
    place: "日本",
    name: "武士刀",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("topgod"))
      : false,
    place: "中國",
    name: "皇上聖旨",
    description:
      "國內已分為兩派 有穿越者之協助 內部將和平一世 鬼怪皆無所遁形(藏頭)",
    img: "/images/topgood.jpg",
  },
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("daedeu"))
      : false,
    place: "中國",
    name: "道德經",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("zerozhi"))
      : false,
    place: "中國",
    name: "靈芝",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("whiteyes"))
      : false,
    place: "中國",
    name: "白起的合作同意書",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("bitfultea"))
      : false,
    place: "中國",
    name: "東方美人茶",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("smart"))
      : false,
    place: "歐洲",
    name: "智力測驗單",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("dorgan"))
      : false,
    place: "歐洲",
    name: "屠龍劍",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("drogangay"))
      : false,
    place: "歐洲",
    name: "龍鱗護甲",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("droganbaby"))
      : false,
    place: "歐洲",
    name: "龍的寶玉",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("originLiou"))
      : false,
    place: "歐洲",
    name: "鍛造原料",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("beatiful"))
      : false,
    place: "歐洲",
    name: "彩虹寶石",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("cando"))
      : false,
    place: "歐洲",
    name: "實力證明",
    description: "證明實力的東西",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("todoprove"))
      : false,
    name: "任務證明",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("chocolate"))
      : false,
    place: "歐洲",
    name: "歐洲進口巧克力",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("farmtwo"))
      : false,
    name: "作物收成表2",
  ...
  {
    displace: process.client
      ? JSON.parse(localStorage.getItem("landk"))
      : false,
    name: "鐮刀和捶子",
